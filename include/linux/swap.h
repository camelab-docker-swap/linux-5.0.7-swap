...
extern int get_public_swap_pages(int n, swp_entry_t swp_entries[], int entry_size);
extern int get_private_swap_pages(int type, int n, swp_entry_t swp_entries[], int entry_size);
